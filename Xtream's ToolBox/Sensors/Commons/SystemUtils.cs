...
namespace XtreamToolbox
{
    ...
    class SystemUtils
    {
        ...
        // récupére des infos sur le contenu de la poubelle
        ...
        // récupére une taille formaté é partir d'un nombre de bit
        ...
        // récupére une durée é partir d'un nombre de secondes
    ...
    class SingleInstanceApp : IDisposable
    {
        ...
        // Application déja lancée ?
        public bool IsRunning()
        {
            // Acquisition du mutex.
            // Si _siMutexOwned vaut true, l'application acquiert le mutex car il est "libre"
            // Sinon le mutex a déjé été acquis lors du lancement d'une instance précédente
